...
function completed({ address, customer, id, price, status }: Props) {
  return (
    <div className="w-full min-h-screen flex justify-center items-center">
      <div className="w-11/12 md:w-5/6 lg:w-3/5 flex items-center flex-col gap-10 mt-16">
        <div>
          ...
          <h3 className="text-slate-500 text-center font-mono text-2xl font-bold">
            Leverans innom 5-7 dagar
          </h3>
        </div>
        <div>
  ...
  return {
    props: {
      address: {
        ...
        line: session.shipping_details.address.line1,
        post: session.shipping_details.address.postal_code,
      },
      customer: {
